...
{
	public int x, y; /** Position affich�e � l'�cran **/
	public int x2, y2; /** Sauvegarde de la position avant maximisation **/
	public int width, height; /** Largeur et hauteur affich�e � l'�cran **/
	public int width2, height2; /** Sauvegarde de la largeur et de la hauteur affich�e � l'�cran **/
	...
	/** Textures des boutons de r�duction, maximisation et fermeture de l'application **/
