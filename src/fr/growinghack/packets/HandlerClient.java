	...
	public void handleAuthentificationError(PacketAuthentificationError packet) 
	{
		switch(packet.error)
		{
			case 0:
				...
				break;
			case 1:
				Logs.error("Un joueur est d�j� enregistr� avec ce pseudo");
				break;
			case 2:
				Logs.error("Cette adresse mail est d�j� utili�e par un autre joueur");
				break;
			case 42:
				Logs.success("Le compte a bien �t� cr��");
				break;
			case 3:
				Logs.error("Votre compte a �t� banni.");
				break;
			case 1337:
